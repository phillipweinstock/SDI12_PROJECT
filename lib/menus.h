...
/* The following 'enum' defines the pin numbers for various settings of the TFT display.
...
- `TFT_MOSI`: The pin number for the serial data (MOSI) pin of the TFT display. It is assigned pin 11.
 */
...
/* These character arrays provide storage space to hold the sensor data as strings,
allowing for further processing or display on the TFT display. The lengths of the
arrays determine the maximum number of characters that can be stored in each array. */
...
the menu option when selected using the corresponding push button */
...
sensor readings as part of the menu option when selected using the corresponding push button */
